...
public class Mm_Controller_Vendas_Carros extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if ( columnIndex == 0 ){
            return vendasCarros.getIdVendasCarros();
        } else if (columnIndex ==1) {
            return vendasCarros.getIdCarros();        
        } else if (columnIndex ==2) {
            return vendasCarros.getQuantidade();
        } else if (columnIndex ==3) {
            return vendasCarros.getValorUnitario();
        } else if (columnIndex ==4) {
            return vendasCarros.getIdVenda();
        }
        return "";
    }
