...
public class JDlgConsultaClientes extends javax.swing.JDialog {
     ...
     */
   Mml_controller_consultarClientes mml_controller_consultarClientes;
    MmlClienteDao mmlClienteDao;
    ...
    public JDlgConsultaClientes(java.awt.Frame parent, boolean modal) {
        ...
        mml_controller_consultarClientes = new Mml_controller_consultarClientes();
        mmlClienteDao = new MmlClienteDao();
        List lista = (List) mmlClienteDao.listAll();
        mml_controller_consultarClientes.setList(lista);
        jTable1.setModel(mml_controller_consultarClientes);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("numero do rg maior que");
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        if (!jTxtValor.getText().isEmpty() && !jTxtNome.getText().isEmpty()) {
            ...
            List listNomrRG = (List) mmlClienteDao.listNomrRG(nome, valor);
            mml_controller_consultarClientes.setList(listNomrRG);
            
        } else if (!jTxtNome.getText().isEmpty()) {
            String nome = jTxtNome.getText();
            
            List listaNome = (List) mmlClienteDao.listNome(nome);
            mml_controller_consultarClientes.setList(listaNome);
            
        } else if (!jTxtValor.getText().isEmpty()){
            String valor = jTxtValor.getText();
            
            List listRG = (List) mmlClienteDao.listRG(valor);
            mml_controller_consultarClientes.setList(listRG);
