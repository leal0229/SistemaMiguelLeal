...
public class JDlgConsultausuarios extends javax.swing.JDialog {
     ...
     */
   Mml_controller_consultarUsuarios mml_controller_consultarUsuarios;
    MmlUsuariosDao mmlUsuariosDao;
    ...
    public JDlgConsultausuarios(java.awt.Frame parent, boolean modal) {
        ...
        mml_controller_consultarUsuarios = new Mml_controller_consultarUsuarios();
        mmlUsuariosDao = new MmlUsuariosDao();
        List lista = (List) mmlUsuariosDao.listAll();
        mml_controller_consultarUsuarios.setList(lista);
        jTable1.setModel(mml_controller_consultarUsuarios);
    }
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        if (!jTxtValor.getText().isEmpty() && !jTxtNome.getText().isEmpty()) {
            ...
            List listNomeApelido = (List) mmlUsuariosDao.listNomeApelido(nome, valor);
            mml_controller_consultarUsuarios.setList(listNomeApelido);
            
        } else if (!jTxtNome.getText().isEmpty()) {
            String nome = jTxtNome.getText();
            
            List listaNome = (List) mmlUsuariosDao.listNome(nome);
            mml_controller_consultarUsuarios.setList(listaNome);
            
        } else if (!jTxtValor.getText().isEmpty()){
            String valor = jTxtValor.getText();
            
            List listaValor = (List) mmlUsuariosDao.listApelido(valor);
            mml_controller_consultarUsuarios.setList(listaValor);
